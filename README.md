![ordersage-logo](https://user-images.githubusercontent.com/92478729/138027824-becd802f-b3c3-410d-961b-86ce435b907a.png)

# OrderSage -- tool for analysis of order-related effects in computer performance

This repo contains the code for running benchmarks in fixed/randomized orders on specified remote resources.

To clone: 
```
git clone https://github.com/sigmetrics174/ordersage.git
```
